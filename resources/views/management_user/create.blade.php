...
@section('content')
    <div class="mx-3">
        ...
        <p class="text-gray-500 text-sm">
            Lengkapi informasi pengguna untuk menambahkan data baru ke dalam sistem. Pastikan semua data yang dimasukkan
            benar dan sesuai dengan format yang ditentukan.
        </p>
    </div>
    <div class="bg-white rounded-xl p-5 m-3 mt-5">
        <form action="{{ route('admin.management_user.store') }}" method="POST" enctype="multipart/form-data"
            class="space-y-6">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama" :value="old('nama')"
                        required autofocus placeholder="Contoh: Ahmad Rizqi" />
                ...
                <div x-data="{ nikLength: 0 }">
                    ...
                    <x-text-input id="nik" class="block mt-1 w-full" type="text" name="nik" :value="old('nik')"
                        maxlength="16" placeholder="Contoh: 1234567890123456" autocomplete="off" inputmode="numeric"
                ...
                <div>
                    ...
                    <x-text-input id="no_wa" class="block mt-1 w-full" type="text" name="no_wa" :value="old('no_wa')"
                        maxlength="15" placeholder="Contoh: 081234567890" autocomplete="off" inputmode="numeric"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="deskripsi" name="deskripsi"
                        class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                        rows="3" placeholder="Contoh: Ketua Tim Elang, Kadus Pakuwon, dll">{{ old('deskripsi', $user->deskripsi ?? '') }}</textarea>
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('admin.management_user.index') }}" class="px-4 py-2 bg-gray-300 rounded-lg">
                    Batall
                </a>
