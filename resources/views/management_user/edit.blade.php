...
@section('content')
    ...
    <div class="bg-white rounded-xl p-5 m-3 mt-5">
        <form action="{{ route('admin.management_user.update', $user->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-6">
            @csrf
            @method('PATCH')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:col-span-2">
                    ...
                    <div>
                        ...
                        <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama"
                            :value="old('nama', $user->nama)" required autofocus placeholder="Contoh: Ahmad Rizqi" />
                ...
                <div>
                    ...
                    <x-text-input id="no_wa" class="block mt-1 w-full" type="text" name="no_wa" :value="old('no_wa', $user->no_wa)"
