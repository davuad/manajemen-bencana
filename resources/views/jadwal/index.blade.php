...
<div class="bg-white rounded-xl shadow p-6 m-3 mt-5">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('jadwal.cetak', request()->all()) }}" target="_blank"
    ...
    {{-- Filter Form --}}
    <form method="GET" action="{{ route('jadwal.index') }}" class="flex flex-wrap items-center gap-2 mb-6 p-4 bg-gray-50 rounded-lg border border-gray-100">
        ...
        <a href="{{ route('jadwal.index') }}" class="text-[10px] text-gray-400 font-bold hover:text-gray-600 uppercase tracking-widest ml-2">
            Reset
        </a>
    </form>
    ...
    <div class="overflow-x-auto border border-gray-100 rounded-lg">
        <table class="w-full text-xs text-left min-w-[1200px]">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="p-4 text-center">
                        <div class="flex gap-2 justify-center">
                            <a href="{{ route('jadwal.edit', $jadwal->id) }}" class="p-2 text-blue-500 hover:bg-blue-50 rounded-lg transition border border-transparent hover:border-blue-200">
                ...
                @empty
                <tr>
                    <td colspan="11" class="text-center p-12 text-gray-400 italic">Belum ada jadwal layanan yang diinput.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
...
<script>
    function openModal(id, nama) {
        ...
        let url = "{{ route('jadwal.destroy', ':id') }}";
