...
@section('content')
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.stok_gudang.create') }}" class="bg-indigo-700 text-white px-4 py-2 rounded-lg">
                + Tambah Stok
            </a>
        </div>
                    ...
                    @forelse($stok as $key => $s)
                        <tr class="border-t hover:bg-gray-50">
                            ...
                            <td class="flex gap-2 py-3">
                                ...
                                {{-- EDIT --}}
                                <a href="{{ route('admin.stok_gudang.edit', $s->id) }}" class="text-blue-500">
                                    ✏️
                                </a>

                                {{-- DELETE --}}
                                <form action="{{ route('admin.stok_gudang.destroy', $s->id) }}" method="POST"
