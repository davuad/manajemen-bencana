...
@section('content')
    <div class="mx-3">
        <h2 class="text-xl font-bold text-gray-800">Tambah Data Dapur Umum</h2>
...
>>>>>>> origin/main
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_dapur_umum" value="{{ old('nama_dapur_umum') }}" class="w-full border rounded-lg p-3"
                ...
                <div>
                    ...
                    <input type="number" name="kapasitas_warga" value="{{ old('kapasitas_warga') }}" class="w-full border rounded-lg p-3"
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_warga" value="{{ old('jumlah_warga') }}" class="w-full border rounded-lg p-3"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="penanggung_jawab" value="{{ old('penanggung_jawab') }}" class="w-full border rounded-lg p-3"
