        ...
        <form action="{{ route('admin.management_posko.dapur_umum.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_dapur_umum" class="w-full border rounded-lg p-3"
                ...
                <div>
                    ...
                    <input type="number" name="kapasitas_warga" class="w-full border rounded-lg p-3"
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_warga" class="w-full border rounded-lg p-3"
                ...
                <div>
                    ...
                    <input type="text" name="penanggung_jawab" class="w-full border rounded-lg p-3"
