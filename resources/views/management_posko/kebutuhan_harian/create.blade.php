...
@section('content')
    ...
    <div class="bg-white rounded-xl p-5 m-3 mt-5 shadow-sm">
        <form action="{{ route('management_posko.kebutuhan_harian.store', ['role' => $userRole, 'dapur' => $dapur->id]) }}" method="POST"
            class="space-y-6">

            @csrf

            {{-- HIDDEN DAPUR ID --}}
            <input type="hidden" name="dapur_umum_id" value="{{ $dapur->id }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" value="{{ $dapur->nama_dapur_umum }}"
                ...
                <div>
                    ...
                    <input type="date" name="tanggal" value="{{ old('tanggal') }}" class="w-full border rounded-lg p-3">
                    @error('tanggal')
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_warga" value="{{ $dapur->jumlah_warga }}"
                        class="w-full border rounded-lg p-3" placeholder="Masukkan jumlah warga" readonly>
                    @error('jumlah_warga')
                        <small class="text-red-500">
                            {{ $message }}
                        </small>
                ...
                <div>
                    ...
                    <input type="number" name="porsi_per_orang" value="{{ old('porsi_per_orang') }}"
                        class="w-full border rounded-lg p-3" placeholder="Contoh: 3 kali makan">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="number" name="total_porsi" value="{{ old('total_porsi') }}"
                        class="w-full border rounded-lg p-3 bg-gray-100" readonly>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-3">
                ...
                <a href="{{ route('management_posko.kebutuhan_harian.index', ['role' => $userRole, 'dapur' => $dapur->id]) }}"
