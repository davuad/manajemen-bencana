...
<div class="bg-white rounded-xl shadow p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        {{-- TAMBAH DATA --}}
        <a href="{{ route('management_posko.kebutuhan_harian.create', $dapur->id) }}"
    ...
    {{-- FILTER --}}
    <form method="GET"
          action="{{ route('management_posko.kebutuhan_harian.index', $dapur->id) }}">
...
{{-- MODAL DELETE --}}
<div id="deleteModal"
     class="fixed inset-0 backdrop-blur-sm bg-black/20 hidden items-center justify-center z-50">
