    ...
    <div class="space-y-6">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
            <div class="border-b border-gray-100 px-6 py-5">
                <h2 class="text-xl font-bold text-gray-900">Tambah Data Desa</h2>
            </div>

            <div class="px-6 py-6 md:px-8 md:py-8">
                <form action="{{ route($userRole . '.desa.store') }}" method="POST" class="space-y-8">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-x-10 md:gap-y-7">
                        ...
                        <div>
                            <label for="nomor_telepon" class="mb-2 block text-sm font-medium text-gray-700">Nomor Handphone</label>
