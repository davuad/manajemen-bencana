    ...
    <div class="space-y-6">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
            ...
            <div class="px-6 py-6 md:px-8 md:py-8">
                <form action="{{ route('warga.update', $warga->id) }}" method="POST" class="space-y-8">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-x-8 md:gap-y-7">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Bantuan Saat Bencana" {{ old('jenis_bantuan', $warga->jenis_bantuan) == 'Bantuan Saat Bencana' ? 'selected' : '' }}>
                                    Bantuan Saat Bencana
                                </option>
                                <option value="Bantuan Pasca Bencana" {{ old('jenis_bantuan', $warga->jenis_bantuan) == 'Bantuan Pasca Bencana' ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                name="alamat"
                                rows="4"
                                placeholder="Masukkan alamat terdampak"
                                class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 outline-none transition focus:border-indigo-600 focus:ring-4 focus:ring-indigo-100"
                        ...
                        <div>
                            ...
                            <select
                                id="status_penyaluran"
                                name="status_penyaluran"
                                class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 outline-none transition focus:border-indigo-600 focus:ring-4 focus:ring-indigo-100"
                            >
                                <option value="">Pilih status penyaluran</option>
                                <option value="Belum diproses" {{ old('status_penyaluran', $warga->status_penyaluran) == 'Belum diproses' ? 'selected' : '' }}>
                                    Belum Diproses
                                </option>
                                <option value="Proses Penyaluran" {{ old('status_penyaluran', $warga->status_penyaluran) == 'Proses Penyaluran' ? 'selected' : '' }}>
                                    Proses Penyaluran
                                </option>
                                <option value="Sudah disalurkan" {{ old('status_penyaluran', $warga->status_penyaluran) == 'Sudah disalurkan' ? 'selected' : '' }}>
                                    Sudah Disalurkan
                                </option>
                            </select>
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach ($desa as $item)
                                    <option value="{{ $item->id }}" {{ old('desa_id', $warga->desa_id) == $item->id ? 'selected' : '' }}>
                                        {{ $item->nama_desa }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach ($bencana as $item)
                                    <option value="{{ $item->id }}" {{ old('bencana_id', $warga->bencana_id) == $item->id ? 'selected' : '' }}>
                                        {{ $item->nama_bencana }}
                                    </option>
                                @endforeach
                            </select>
