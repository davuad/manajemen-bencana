    ...
    <div class="space-y-6">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
            <div class="flex flex-col gap-4 border-b border-gray-100 px-6 py-5 lg:flex-row lg:items-start lg:justify-between">
                <div>
                    <h2 class="text-xl font-bold text-gray-900 uppercase tracking-wide">Detail Data Warga Terdampak</h2>
                ...
                <div class="flex flex-col gap-3 sm:flex-row">
                    ...
                    @if ($canManage)
                        <a href="{{ route($userRole . '.warga.edit', $warga->id) }}"
            ...
            <div class="space-y-6 px-6 py-6">
                <div class="grid grid-cols-1 gap-5 lg:grid-cols-3">
                    <div class="rounded-2xl border border-gray-200 bg-white p-5 lg:col-span-2">
                        <div class="mb-5 flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-gray-900">{{ $warga->nama_kepala_keluarga }}</h3>
                                <p class="mt-1 text-sm text-gray-500">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                @if ($warga->status_penyaluran == 'Belum diproses')
                                    <span class="inline-flex rounded-full bg-red-100 px-3 py-1.5 text-xs font-semibold text-red-700">Belum Diproses</span>
                                @elseif ($warga->status_penyaluran == 'Proses Penyaluran')
                                    <span class="inline-flex rounded-full bg-blue-100 px-3 py-1.5 text-xs font-semibold text-blue-700">Proses Penyaluran</span>
                                @elseif ($warga->status_penyaluran == 'Sudah disalurkan')
                                    <span class="inline-flex rounded-full bg-green-100 px-3 py-1.5 text-xs font-semibold text-green-700">Sudah Disalurkan</span>
                                @else
                                    <span class="inline-flex rounded-full bg-gray-100 px-3 py-1.5 text-xs font-semibold text-gray-700">{{ $warga->status_penyaluran }}</span>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <h3 class="mb-4 text-lg font-bold text-gray-900">Informasi Lengkap</h3>
