...
@section('content')
    <div class="space-y-6">
        ...
        <div class="text-sm text-gray-500">
            Dashboard <span class="mx-1">&gt;</span> Data Warga Terdampak <span class="mx-1">&gt;</span> Tambah Data Warga
            Terdampak
        </div>
                        ...
                        <div>
                            ...
                            <select id="jenis_bantuan" name="jenis_bantuan"
                                ...
                                <option value="Bantuan Saat Bencana"
                                    {{ old('jenis_bantuan') == 'Bantuan Saat Bencana' ? 'selected' : '' }}>
                                    Bantuan Saat Bencana
                                </option>
                                <option value="Bantuan Pasca Bencana"
                                    {{ old('jenis_bantuan') == 'Bantuan Pasca Bencana' ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select id="status_penyaluran" name="status_penyaluran"
                                ...
                                <option value="Belum diproses"
                                    {{ old('status_penyaluran') == 'Belum diproses' ? 'selected' : '' }}>
                                    Belum Diproses
                                </option>
                                <option value="Proses Penyaluran"
                                    {{ old('status_penyaluran') == 'Proses Penyaluran' ? 'selected' : '' }}>
                                    Proses Penyaluran
                                </option>
                                <option value="Sudah disalurkan"
                                    {{ old('status_penyaluran') == 'Sudah disalurkan' ? 'selected' : '' }}>
                                    Sudah Disalurkan
                                </option>
                            </select>
