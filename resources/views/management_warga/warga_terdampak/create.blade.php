                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-x-8 md:gap-y-7">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Bantuan Saat Bencana" {{ old('jenis_bantuan') == 'Bantuan Saat Bencana' ? 'selected' : '' }}>
                                    Bantuan Saat Bencana
                                </option>
                                <option value="Bantuan Pasca Bencana" {{ old('jenis_bantuan') == 'Bantuan Pasca Bencana' ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Belum diproses" {{ old('status_penyaluran') == 'Belum diproses' ? 'selected' : '' }}>
                                    Belum Diproses
                                </option>
                                <option value="Proses Penyaluran" {{ old('status_penyaluran') == 'Proses Penyaluran' ? 'selected' : '' }}>
                                    Proses Penyaluran
                                </option>
