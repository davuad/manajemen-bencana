...
document.getElementById('pengambilan')
.addEventListener('change', function () {
    ...
    // HEADER
    document.getElementById('bencana').innerText =
        option.dataset.bencana || '-';

    document.getElementById('tujuan').innerText =
        option.dataset.tujuan || '-';

    document.getElementById('petugas').innerText =
        option.dataset.petugas || '-';

    document.getElementById('posko').innerText =
        option.dataset.posko || '-';
