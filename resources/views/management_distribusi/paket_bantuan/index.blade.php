...
@section('content')
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('management_distribusi.paket_bantuan.create') }}"
        ...
        {{-- FILTER --}}
        <form method="GET" action="{{ route('management_distribusi.paket_bantuan.index') }}">
                    ...
                    @forelse($paket_bantuan as $key => $p)
                        <tr class="border-t">
                            ...
                            <td class="flex gap-2 py-4">
                                <a href="{{ route('management_distribusi.detail_paket.index', ['paket_bantuan_id' => $p->id]) }}"
                                    class="text-green-600">
                                    <x-heroicon-o-clipboard-document-list class="w-5 h-5" />
                                </a>
                                
                                <a href="{{ route('management_distribusi.paket_bantuan.edit', $p->id) }}"
                                    class="text-blue-500">
    ...
    <script>
        function openModal(id, nama) {
            ...
            let url = "{{ route('management_distribusi.paket_bantuan.destroy', ':id') }}";
