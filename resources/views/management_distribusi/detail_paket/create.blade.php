...
@endphp
    ...
    <div class="bg-white rounded-xl p-5 m-3 mt-5">
        ...
        <form action="{{ route($routePrefix .'.management_distribusi.detail_paket.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route($routePrefix .'.management_distribusi.detail_paket.index', ['paket_bantuan_id' => $paket_bantuan->id]) }}"
