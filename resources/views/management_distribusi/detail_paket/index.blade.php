...
@endphp
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <div class="flex justify-between items-start mb-6">
            <div>
                ...
                <a href="{{ route($routePrefix .'.management_distribusi.paket_bantuan.index') }}"
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex gap-3 items-center">
                <form method="GET" action="{{ route($routePrefix .'.management_distribusi.detail_paket.index') }}" class="flex gap-2">
                ...
                <a href="{{ route($routePrefix .'.management_distribusi.detail_paket.create', ['paket_bantuan_id' => $paket_bantuan->id]) }}"
                        ...
                        <tr class="border-b">
                            ...
                            <td class="p-4">
                                <div class="flex gap-2">
                                    <a href="{{ route($routePrefix .'.management_distribusi.detail_paket.edit', $item->id) }}"
    ...
    <script>
        function openModal(id, nama) {
            ...
            let url = "{{ route($routePrefix .'.management_distribusi.detail_paket.destroy', ':id') }}";
