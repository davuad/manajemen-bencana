...
@section('content')
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.kategori_bencana.create') }}"
        ...
        {{-- Search --}}
        <form method="GET" action="{{ route('admin.kategori_bencana.index') }}">
                    ...
                    @forelse($kategori as $key => $k)
                        <tr class="border-t">
                            ...
                            <td class="flex gap-2 py-3">
                                ...
                                {{-- Edit --}}
                                <a href="{{ route('admin.kategori_bencana.edit', $k->id) }}" class="text-blue-500">
                                    ✏️
                                </a>

                                {{-- Delete --}}
                                <form action="{{ route('admin.kategori_bencana.destroy', $k->id) }}" method="POST"
