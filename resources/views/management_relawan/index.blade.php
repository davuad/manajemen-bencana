        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-t">
                    ...
                    <td class="p-2 text-center">{{ $r->nama_relawan }}</td>
                    <td class="p-2 text-center">{{ $r->jenis_psks }}</td>
                    <td class="p-2 text-center">{{ $r->kecamatan }}</td>
                    <td class="p-2 text-center">{{ $r->no_hp }}</td>
                    <td class="p-2 text-center">{{ $r->alamat }}</td>

                    <td class="flex gap-2 py-3">
                        <a href="{{ url('/relawan/'.$r->id_relawan.'/edit') }}"
...
<div id="deleteModal" class="fixed inset-0 backdrop-blur-sm bg-white/10 hidden items-center justify-center z-50">
    ...
    <div class="bg-white rounded-2xl shadow-lg w-full max-w-md p-6">
        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-800">Hapus Data Relawan</h2>
