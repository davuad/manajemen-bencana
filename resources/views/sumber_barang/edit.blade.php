...
<div class="mx-3">
    <h2 class="text-xl font-bold">Edit Sumber Barang</h2>
    <p class="text-gray-500 text-sm">
        Perbarui data sumber barang agar tetap akurat
    </p>
</div>
...
<div class="bg-white rounded-xl p-5 m-3 mt-5">
    ...
    <form action="{{ route('admin.sumber-barang.update', $data->id_sumber) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- ID -->
            <div>
                <label class="block font-medium">ID Sumber Barang</label>
                <input type="text"
                       value="{{ $data->id_sumber }}"
